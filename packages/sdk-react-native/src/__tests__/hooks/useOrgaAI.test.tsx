...
import { logger, connectToRealtime, getMediaConstraints } from '../../utils';
import { ConnectionError, SessionError, ConfigurationError, PermissionError } from '../../errors';
import { DataChannelEventTypes, ConnectionState, CameraPosition } from '../../types';
...
describe('useOrgaAI', () => {
  ...
  describe('Session Management', () => {
    ...
    it('should handle session start error', async () => {
      (connectToRealtime as jest.Mock).mockRejectedValue(new ConnectionError('Connection failed'));
      const { result } = renderHook(() => useOrgaAI(mockCallbacks));
